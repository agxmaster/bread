...
import (
	...
	metricCollector "git.qutoutiao.net/gopher/qms/third_party/forked/afex/hystrix-go/hystrix/metric_collector"
	"git.qutoutiao.net/gopher/qms/third_party/forked/afex/hystrix-go/hystrix/rolling"
)
