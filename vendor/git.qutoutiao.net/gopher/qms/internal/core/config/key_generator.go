...
const (
	...
	PropertyRespCacheInMilliseconds   = "respCacheMs"
...
// GetRespCacheKey get resp cache key
func GetRespCacheKey(command string) string {
	return GetHystrixSpecificKey(NamespaceIsolation, command, PropertyRespCacheInMilliseconds)
}

// GetDefaultRespCacheKey get default resp cache key
func GetDefaultRespCacheKey(t string) string {
	return GetHystrixSpecificKey(NamespaceIsolation, t, PropertyRespCacheInMilliseconds)
}
