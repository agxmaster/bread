...
type RegistryStruct struct {
	...
	AutoRegister    string                   `yaml:"register"` //Deprecated
	DisableRegister bool                     `yaml:"registerDisabled"`
	...
	Registrator       RegistratorStruct       `yaml:"registrator"`       //Deprecated
	ServiceDiscovery  ServiceDiscoveryStruct  `yaml:"serviceDiscovery"`  //Deprecated
	ContractDiscovery ContractDiscoveryStruct `yaml:"contractDiscovery"` //Deprecated
