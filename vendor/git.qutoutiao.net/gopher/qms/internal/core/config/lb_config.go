...
func GetSessionTimeout(source, service string) int {
	...
	ms := qconf.GetInt(genKey(lbPrefix, service, propertySessionStickinessRuleTimeout), global)
	lbMutex.RUnlock()
	return ms
}
...
func StrategySuccessiveFailedTimes(source, service string) int {
	...
	ms := qconf.GetInt(genKey(lbPrefix, service, propertySessionStickinessRuleFailedTimes), global)
	lbMutex.RUnlock()
	return ms
}
...
//	ms := qconf.GetBool(genKey(lbPrefix, service, propertyRetryEnabled), global)
//	lbMutex.RUnlock()
//	return ms
//}
...
//	ms := qconf.GetInt(genKey(lbPrefix, service, propertyRetryOnNext), global)
//	lbMutex.RUnlock()
//	return ms
//}
...
//	ms := qconf.GetInt(genKey(lbPrefix, service, propertyRetryOnSame), global)
//	lbMutex.RUnlock()
//	return ms
//}
...
//	ms := qconf.GetInt(genKey(lbPrefix, service, propertyBackoffMinMs), global)
//	return ms
//}
...
//	ms := qconf.GetInt(genKey(lbPrefix, service, propertyBackoffMaxMs), global)
//	return ms
//}
